...
!(function (n) {
                ...
                var L,
                  ...
                  O = function () {
                    ...
                    var e = o.children("caption"),
                      e =
                        (u.caption &&
                          (e = 0 === e.length ? V("<caption/>").appendTo(o) : e).html(u.caption),
                        e.length &&
                          ((e[0]._captionSide = e.css("caption-side")), (u.captionNode = e[0])),
        ...
        : null === a
          ...
          : "function" == typeof a
            ...
            : "string" != typeof a ||
              ...
              : ((f = function (t, e, n) {
                  for (
                    var a, r, o, i, l = ft(n), n = l[l.length - 1], s = 0, u = l.length - 1;
                    s < u;
                    s++
                  ) {
          ...
          f.find("thead th, thead td").each(function () {
            ...
            t
              ? ((this.style.width = t),
                s &&
                  V(this).append(
                    V("<div/>").css({ width: t, margin: 0, padding: 0, border: 0, height: 1 }),
                  ))
              : (this.style.width = "");
          }),
          n = 0;
    ...
    for (
      ...
      if (h && !o._render) {
        ...
        for (var p, g = t, m = d, v = g.aoData, b = 0; b < v.length; b++)
          v[b].nTr &&
            ((p = G(g, b, m, "display")), (v[b].displayData[m] = p), ct(v[b].anCells[m], p));
      }
    }
  }
  function it(t, e, n) {
  ...
  function G(t, e, n, a) {
    ...
    if (r) {
      ...
      if (
        void 0 ===
        (s = "display" !== a && s && "object" == typeof s && s.nodeName ? s.innerHTML : s)
      )
        return (
          t.iDrawError != o &&
            null === l &&
    ...
    if (
      ...
      if (0 !== o.length)
        for (var d = r ? t.aoData.length : s, f = r ? 0 : i; f < d; f++) {
          for (
            var h = o[f], p = t.aoData[h], g = (null === p.nTr && bt(t, h), p.nTr), m = 0;
            m < u.length;
            m++
          ) {
            var v = u[m],
  ...
  function wt(t, e, n) {
    for (
      ...
      a[o].val.full &&
        (r.push({ full: a[o].val.full }), _t(t, r[r.length - 1]), delete a[o].val.full),
          ...
          ("string" == typeof n[a]
            ...
            : V.isPlainObject(n[a])
              ...
              : "function" == typeof n[a].node
                ? (n[a] = n[a].node(o))
                : "function" == typeof n[a] &&
                  ((e = n[a](o)), (n[a] = "function" == typeof e.node ? e.node() : e)));
    });
  }
  function Ct(e) {
    var a,
    ...
    if (((e.nTableWrapper = r[0]), e.sDom))
      for (
        var o, i, l, s, u, c, d = e, t = e.sDom, f = r, h = t.match(/(".*?")|('.*?')|./g), p = 0;
        p < h.length;
        p++
      )
        (o = null),
    ...
    n.bInitialised
      ? (Dt(n, "header"),
        ...
        Vt(
          t,
          e,
          e === t.nTHead ? "tr" + o + " th" + o + ", tr" + o + " td" + o : "th" + o + ", td" + o,
        ),
        Ut(t, (r = []), t.aaSorting),
        (t.aaSorting = r),
        Bt(n),
  ...
  function zt(t, e, n) {
    ...
    for (
      ...
      for (var D = $.ext.type.order[b.sType + "-pre"], x = m.aoData, S = 0; S < x.length; S++)
        x[S] &&
          ...
          (p._aSortData[v] && !y) ||
            ((g = y ? h[S] : G(m, S, v, "sort")), (p._aSortData[v] = D ? D(g, m) : g)));
    }
    if ("ssp" != et(t) && 0 !== c.length) {
      ...
      c.length && "desc" === c[0].dir && d.reverse(),
        u.sort(function (t, e) {
          for (
            var n, a, r, o, i = c.length, l = f[t]._aSortData, s = f[e]._aSortData, u = 0;
            u < i;
            u++
          )
  ...
  function Z(t, e, n, a) {
    if (
      ...
      a &&
        (n += ". For more information about this error, please see https://datatables.net/tn/" + a),
      e)
    )
      ...
      iterator: function (t, e, n, a) {
        ...
        for (
          ...
          if ("table" === e) void 0 !== (r = n.call(g, h[o], o)) && f.push(r);
            ...
            for (
              c = this[o], "column-rows" === e && (u = he(h[o], p.opts)), l = 0, s = c.length;
              l < s;
              l++
            )
              (d = c[l]),
          ...
          for (var r = t.split("."), o = ne, i = 0, l = r.length; i < l; i++) {
            ...
            c || o.push((c = { name: u, val: {}, methodExt: [], propExt: [], type: "object" })),
              i === l - 1
                ? ((c.val = e),
                  (c.type =
                    "function" == typeof e ? "function" : V.isPlainObject(e) ? "object" : "other"))
  ...
  function oe(t, e, n, a, r) {
    for (
      ...
      for (
        l = 0,
          s = (i = e[d] && e[d].split && !e[d].match(/[[(:]/) ? e[d].split(",") : [e[d]]).length;
        l < s;
        l++
      )
  ...
  var he = function (t, e) {
      ...
      if ("current" == e) for (u = t._iDisplayStart, c = t.fnDisplayEnd(); u < c; u++) a.push(r[u]);
        ...
        if ("none" === i) a = d;
          ...
          for (u = 0; u < d.length; u++)
            ((-1 === (n = r.indexOf(d[u])) && "removed" == i) || (0 <= n && "applied" == i)) &&
              a.push(d[u]);
      }
      return a;
    },
    ...
    ye =
      ...
      e(ve + ".isShown()", function () {
        var t = this.context;
        return (
          (t.length && this.length && t[0].aoData[this[0]] && t[0].aoData[this[0]]._detailsShow) ||
          !1
        );
      }),
    ...
    be =
                      ...
                      if (null == t || n) {
                        for (o = [], i = 0, l = f.length; i < l; i++)
                          for (r = f[i], s = 0; s < p; s++)
                            (u = { row: r, column: s }),
                              (!n ||
                                ((c = d[r]), t(u, G(a, r, s), c.anCells ? c.anCells[s] : null))) &&
                                o.push(u);
                        return o;
                      }
      ...
      ($.versionCheck = function (t, e) {
        for (
          var n, a, r = (e || $.version).split("."), o = t.split("."), i = 0, l = o.length;
          i < l;
          i++
        )
          ...
          this.iterator("table", function (t) {
            var e = t.oClasses,
              ...
              a =
                ...
                !c &&
                  o &&
                  (o.insertBefore(n, r), i.css("width", t.sDestroyWidth).removeClass(e.table)),
                $.settings.indexOf(t));
      ...
      function (t, e, n, a) {
        ...
        return 0 === t || (t && "-" !== t)
          ? "number" == (r = typeof t) || "bigint" == r
            ? t
            : +(t =
                (t = e ? R(t, e) : t).replace && (n && (t = t.replace(n, "")), a)
                  ? t.replace(a, "")
                  : t)
          : -1 / 0;
      });
        ...
        "disable" === f.attr("data-dt-order") ||
          ...
          V(d.nTable).on("order.dt.DT", function (t, e, n) {
            ...
            d === e &&
              ...
              f.attr(
                "aria-label",
                o ? r.ariaTitle + e.api.i18n("oAria.orderable" + i) : r.ariaTitle,
              ),
              o) &&
  ...
  $.feature.register(
    ...
    function (n, t) {
      ...
      return n.oFeatures.bFilter
        ? ((e = n.oClasses.search),
          ...
          -1 ===
            (t = V.extend({ placeholder: c.sSearchPlaceholder, text: c.sSearch }, t)).text.indexOf(
              "_INPUT_",
            ) && (t.text += "_INPUT_"),
          (t.text = ee(n, t.text)),
    ...
    $.feature.register(
      ...
      function (t, e) {
        ...
        (e = V.extend(
          { buttons: $.ext.pager.numbers_length, type: t.sPaginationType, boundaryNumbers: !0 },
          e,
