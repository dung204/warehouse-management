...
class Animator {
  ...
  _notify(e, i, a, t) {
    const s = i.listeners[t],
      n = i.duration;
    s.forEach((t) =>
      t({ chart: e, initial: i.initial, numSteps: n, currentStep: Math.min(a - i.start, n) }),
    );
  }
  _refresh() {
    this._request ||
  ...
  _update(r = Date.now()) {
    ...
    this._charts.forEach((a, s) => {
      if (a.running && a.items.length) {
        ...
        for (; 0 <= t; --t)
          (i = n[t])._active
            ? (i._total > a.duration && (a.duration = i._total), i.tick(r), (e = !0))
            : ((n[t] = n[n.length - 1]), n.pop());
        e && (s.draw(), this._notify(s, a, r, "progress")),
          n.length || ((a.running = !1), this._notify(s, a, r, "complete"), (a.initial = !1)),
          (o += n.length);
      }
    }),
      (this._lastDate = r),
...
function resolveTargetOptions(e, i) {
  if (i) {
    ...
    if (t)
      return (
        t.$shared && (e.options = t = Object.assign({}, t, { $shared: !1, $animations: {} })), t
      );
    e.options = i;
  }
}
...
function toClip(t) {
  let e, i, a, s;
  return (
    isObject(t) ? ((e = t.top), (i = t.right), (a = t.bottom), (s = t.left)) : (e = i = a = s = t),
...
const isDirectUpdateMode = (t) => "reset" === t || "none" === t,
  ...
  createStack = (t, e, i) =>
    t && !e.hidden && e._stacked && { keys: getSortedDatasetIndices(i, !0), values: null };
class DatasetController {
  ...
  parsePrimitiveData(t, e, i, a) {
    ...
    let c, u, g;
    for (c = 0, u = a; c < u; ++c)
      (g = c + i), (d[c] = { [r]: h || s.parse(l[g], g), [o]: n.parse(e[g], g) });
    return d;
  }
  parseArrayData(t, e, i, a) {
    ...
    let o, l, h, d;
    for (o = 0, l = a; o < l; ++o)
      (d = e[(h = o + i)]), (r[o] = { x: s.parse(d[0], h), y: n.parse(d[1], h) });
    return r;
  }
  parseObjectData(t, e, i, a) {
    ...
    for (h = 0, d = a; h < d; ++h)
      (u = e[(c = h + i)]),
        (l[h] = { x: s.parse(resolveObjectKey(u, r), c), y: n.parse(resolveObjectKey(u, o), c) });
    return l;
  }
  getParsed(t) {
  ...
  applyStack(t, e, i) {
    var a = this.chart,
      ...
      n = e[t.axis];
    return applyStack(
      { keys: getSortedDatasetIndices(a, !0), values: e._stacks[t.axis]._visualValues },
      n,
      s.index,
      { mode: i },
    );
  ...
  _update(t) {
    ...
    this.update(t || "default"),
      (e._clip = toClip(
        valueOrDefault(this.options.clip, defaultClip(e.xScale, e.yScale, this.getMaxOverflow())),
      ));
  }
  update(t) {}
  draw() {
  ...
  getContext(t, e, i) {
    ...
    if (0 <= t && t < this._cachedMeta.data.length) {
      ...
      ((s = n.$context || (n.$context = createDataContext(this.getContext(), t, n))).parsed =
        this.getParsed(t)),
        (s.raw = a.data[t]),
      ...
      ((s =
        this.$context ||
        (this.$context = createDatasetContext(this.chart.getContext(), this.index))).dataset = a),
  ...
  _removeElements(t, e) {
    const i = this._cachedMeta;
    var a;
    this._parsing && ((a = i._parsed.splice(t, e)), i._stacked && clearStacks(i, a)),
      i.data.splice(t, e);
  }
  _sync(t) {
    var e, i, a;
  ...
  _getStacks(t, i) {
    ...
    for (const r of a)
      if (
        ...
        ((!1 === s || -1 === n.indexOf(r.stack) || (void 0 === s && void 0 === r.stack)) &&
          n.push(r.stack),
        r.index === t)
      )
        break;
  ...
  _calculateBarValuePixels(t) {
    ...
    return (
      ...
      Math.abs(p) < n &&
        ...
        i &&
          !h &&
          (o._stacks[e.axis]._visualValues[a] = e.getValueForPixel(g) - e.getValueForPixel(m))),
    ...
    return (
      (l = e.grouped
        ? ((a = n ? this._getStackCount(t) : e.stackCount),
          (s = ("flex" === s.barThickness ? computeFlexCategoryTraits : computeFitCategoryTraits)(
            t,
            e,
            s,
            a,
  ...
  updateElements(e, i, a, s) {
    ...
    for (let t = i; t < i + a; t++) {
      ...
      (f.skip = isNaN(p) || isNaN(g)),
        h &&
          ((f.options = l || this.resolveDataElementOptions(t, u.active ? "active" : s)),
    ...
    for (let t = 0; t < x; ++t) {
      ...
      t < i || t >= v
        ...
        : ((_ = this.getParsed(t)),
          ...
          (S = M[u] =
            s || y ? r.getBasePixel() : r.getPixelForValue(o ? this.applyStack(r, _, o) : _[u], t)),
...
class PolarAreaController extends DatasetController {
  ...
  _updateRadius() {
    ...
    var e = t.chartArea,
      ...
      e = Math.max(e / 2, 0),
      i =
        (e - Math.max(i.cutoutPercentage ? (e / 100) * i.cutoutPercentage : 1, 0)) /
  ...
  updateElements(e, i, a, s) {
    ...
    for (let t = i; t < i + a; ++t) {
      ...
      var y = isNullOrUndef(_[g]),
        ...
        S = (D[g] =
          n || y ? o.getBasePixel() : o.getPixelForValue(l ? this.applyStack(o, _, l) : _[g], t));
...
function getAxisItems(t, a, s, e, n) {
  ...
  return (
    evaluateInteractionItems(t, s, a, (t, e, i) => {
      t[o](a[s], n) &&
        (r.push({ element: t, datasetIndex: e, index: i }), (l = l || t.inRange(a.x, a.y, n)));
    }),
    e && !l ? [] : r
  );
}
...
class DomPlatform extends BasePlatform {
  ...
  addEventListener(t, e, i) {
    ...
    const s =
      { attach: createAttachObserver, detach: createDetachObserver, resize: createResizeObserver }[
        e
  ...
  removeEventListener(t, e) {
    ...
    if (a) {
      const s =
        { attach: releaseObserver, detach: releaseObserver, resize: releaseObserver }[e] ||
        removeListener;
      s(t, e, a), (i[e] = void 0);
    }
  }
...
function autoSkip(i, a) {
  ...
  if (0 < s) {
    ...
    for (skip(a, l, h, isNullOrUndef(i) ? 0 : r - i, r), t = 0, e = s - 1; t < e; t++)
...
class Scale extends Element {
        ...
        (s.offset ? this.maxWidth / r : a / (r - 1)) < e + 6 &&
          ...
          (h = toDegrees(
            Math.min(
              ...
              Math.asin(_limitValue(r / n, -1, 1)) - Math.asin(_limitValue(i / n, -1, 1)),
            ),
          )),
  ...
  fit() {
    ...
    d &&
      ...
      this._handleMargins(),
      c
        ? ((this.width = this._length = r.width - this._margins.left - this._margins.right),
  ...
  _calculatePadding(i, a, s, n) {
    ...
    if (this.isHorizontal()) {
      ...
      let t = 0,
        e = 0;
      h
        ? (e = l ? ((t = n * i.width), s * a.height) : ((t = s * i.height), n * a.width))
        : "start" === r
          ? (e = a.width)
          : "end" === r
            ? (t = i.width)
      ...
      let t = a.height / 2,
        e = i.height / 2;
      "start" === r ? ((t = 0), (e = i.height)) : "end" === r && ((t = a.height), (e = 0)),
        (this.paddingTop = t + o),
  ...
  _getLabelSizes() {
    ...
    if (!e) {
      ...
      i < t.length && (t = sample(t, i)),
        (this._labelSizes = e =
          this._computeLabelSizes(t, t.length, this.options.ticks.maxTicksLimit));
    }
    return e;
  }
  ...
  drawTitle() {
    ...
    if (a.display) {
      ...
      "bottom" === i || "center" === i || isObject(i)
        ? ((t += r.bottom), isArray(a.text) && (t += n.lineHeight * (a.text.length - 1)))
        : (t += r.top);
...
class TypedRegistry {
  ...
  unregister(t) {
    ...
    var t = t.id,
      i = this.scope;
    t in e && delete e[t],
      i && t in defaults[i] && (delete defaults[i][t], this.override && delete overrides[t]);
  }
}
...
function createDescriptors(t, { plugins: e, localIds: i }, a, s) {
  ...
  for (const h of e) {
    var o = h.id,
      l = getOpts(a[o], s);
    null !== l &&
      n.push({ plugin: h, options: pluginOpts(t.config, { plugin: h, local: i[o] }, l, r) });
  }
  return n;
}
...
function determineAxis(t, ...e) {
  ...
  for (const a of e) {
    var i =
      a.axis || axisFromPosition(a.position) || (1 < t.length && idMatchesAxis(t[0].toLowerCase()));
    if (i) return i;
  }
  throw new Error(
...
function getResolver(t, e, i) {
  ...
  return (
    s ||
      ...
      (s = { resolver: e, subPrefixes: i.filter((t) => !t.toLowerCase().includes("hover")) }),
      a.set(t, s)),
    s
  );
}
const hasFunction = (e) =>
  isObject(e) && Object.getOwnPropertyNames(e).some((t) => isFunction(e[t]));
...
class Chart {
  ...
  buildOrUpdateScales() {
    ...
    a &&
      ...
      each(t, (t) => {
        ...
        (void 0 !== e.position &&
          positionIsHorizontal(e.position, a) === positionIsHorizontal(t.dposition)) ||
  ...
  _updateDataset(t, e) {
    ...
    !1 !== this.notifyPlugins("beforeDatasetUpdate", a) &&
      (i.controller._update(e), (a.cancelable = !1), this.notifyPlugins("afterDatasetUpdate", a));
  }
  render() {
  ...
  updateHoverStyle(t, e, i) {
    ...
    for (
      "dataset" === e &&
        (s = this.getDatasetMeta(t[0].datasetIndex)).controller["_" + a + "DatasetHoverStyle"](),
        r = 0,
        o = t.length;
      r < o;
      ++r
  ...
  setActiveElements(t) {
    ...
    _elementsEqual(t, e) ||
      ((this._active = t), (this._lastEvent = null), this._updateHoverStyles(t, e));
  }
  notifyPlugins(t, e, i) {
  ...
  _updateHoverStyles(t, e, i) {
    var a = this.options.hover,
      s = (t, i) =>
        t.filter((e) => !i.some((t) => e.datasetIndex === t.datasetIndex && e.index === t.index)),
      n = s(e, t),
      i = i ? t : s(t, e);
  ...
  _handleEvent(t, e, i) {
    var { _active: a = [], options: s } = this,
      ...
      i =
        ...
        !_elementsEqual(n, a));
    return (
      (i || e) && ((this._active = n), this._updateHoverStyles(n, a, e)), (this._lastEvent = o), i
    );
  }
...
class LineElement extends Element {
  ...
  draw(t, e, i, a) {
    var s = this.options || {};
    (this.points || []).length && s.borderWidth && (t.save(), draw(t, this, i, a), t.restore()),
...
function getBarBounds(t, e) {
  ...
  return (
    (h = t.horizontal
      ? ((d = n / 2), (r = Math.min(e, a)), (o = Math.max(e, a)), (l = i - d), i + d)
      : ((d = s / 2), (r = e - d), (o = e + d), (l = Math.min(i, a)), Math.max(i, a))),
...
function lttbDecimation(a, s, n, t, e) {
  ...
  for (r[l++] = a[h], d = 0; d < i - 2; d++) {
    ...
    var f = Math.floor(d * o) + 1 + s,
      ...
      { x: b, y: _ } = a[h];
    for (u = -1, i = f; i < x; i++)
      (g = 0.5 * Math.abs((b - t) * (a[i].y - _) - (b - a[i].x) * (e - _))) > u &&
        ((u = g), (c = a[i]), (p = i));
    (r[l++] = c), (h = p);
  }
  return (r[l++] = a[e]), r;
...
function _createBoundaryLine(t, e) {
  ...
  return (i = isArray(t) ? ((a = !0), t) : _pointsFromSegments(t, e)).length
    ? new LineElement({ points: i, options: { tension: 0 }, _loop: a, _fullLoop: a })
    : null;
}
...
function parseFillOption(t) {
  ...
  return (
    !1 !== (i = void 0 === i ? !!t.backgroundColor : i) && null !== i && (!0 === i ? "origin" : i)
  );
}
...
function computeBoundary(t) {
  return (
    (t.scale || {}).getPointPositionForValue ? computeCircularBoundary : computeLinearBoundary
  )(t);
}
...
function computeCircularBoundary(t) {
  ...
  if (t.grid.circular)
    return (
      ...
      new simpleArc({ x: t.x, y: t.y, radius: e.getDistanceFromCenterForValue(n) })
    );
...
function _drawfill(t, e, i) {
  ...
  a &&
    e.points.length &&
    (clipArea(t, i),
    doFill(t, { line: e, target: a, above: o, below: r, area: i, scale: s, axis: n }),
    unclipArea(t));
}
function doFill(t, e) {
...
function clipVertical(t, e, i) {
  ...
  for (const d of a) {
    ...
    n ? (t.moveTo(h.x, h.y), (n = !1)) : (t.lineTo(h.x, i), t.lineTo(h.x, h.y)),
      (r = !!e.pathSegment(t, d, { move: r })) ? t.closePath() : t.lineTo(o.x, i);
  }
...
const getBoxSize = (t, e) => {
    ...
    return (
      t.usePointStyle && ((i = Math.min(i, e)), (a = t.pointStyleWidth || Math.min(a, e))),
      { boxWidth: a, boxHeight: i, itemHeight: Math.max(e, i) }
    );
  },
  itemsEqual = (t, e) =>
    null !== t && null !== e && t.datasetIndex === e.datasetIndex && t.index === e.index;
class Legend extends Element {
  ...
  _fitCols(t, a, s, n) {
    ...
    return (
      this.legendItems.forEach((t, e) => {
        ...
        0 < e &&
          g + i + 2 * o > d &&
          ((c += u + o), h.push({ width: u, height: g }), (p += u + o), f++, (u = g = 0)),
  ...
  adjustHitBoxes() {
    if (this.options.display) {
      ...
      if (this.isHorizontal()) {
        ...
        for (const o of a)
          t !== o.row &&
            ((t = o.row), (e = _alignStartEnd(s, this.left + n, this.right - this.lineWidths[t]))),
            (o.top += this.top + i + n),
  ...
  _draw() {
    ...
    const { boxWidth: M, boxHeight: P, itemHeight: A } = getBoxSize(v, k),
      ...
      O =
        ((D = w
          ? { x: _alignStartEnd(m, this.left + y, this.right - p[0]), y: this.top + y + C, line: 0 }
          : {
              x: this.left + y,
      ...
      b.setWidth(this.width),
        w
          ? 0 < e &&
            ...
            ((n = D.y += O),
            D.line++,
            (s = D.x = _alignStartEnd(m, this.left + y, this.right - p[D.line])))
          : 0 < e &&
            n + O > this.bottom &&
    ...
    isListened(t.type, s) &&
      ...
      "mousemove" === t.type || "mouseout" === t.type
        ? ((i = this._hoveredItem),
          ...
          (this._hoveredItem = e) && !a && callback(s.onHover, [t, e, this], this))
...
const positioners = {
  ...
  nearest(t, e) {
    ...
    for (n = 0, r = t.length; n < r; ++n) {
      ...
      d &&
        d.hasValue() &&
        ((l = d.getCenterPoint()), (l = distanceBetweenPoints(e, l)) < s && ((s = l), (o = d)));
    }
    var h;
    ...
    for (
      ...
      for (
        m = a[b],
          ...
          each(m.before, p),
          x = m.lines,
          r && x.length && (this._drawColorBox(i, e, b, g, t), (c = Math.max(d.lineHeight, o))),
          _ = 0,
          k = x.length;
        _ < k;
        ++_
...
var plugin_tooltip = {
    ...
    afterDraw(t) {
      ...
      e &&
        e._willRender() &&
        !(i = { tooltip: e }) !== t.notifyPlugins("beforeTooltipDraw", { ...i, cancelable: !0 }) &&
        (e.draw(t.ctx), t.notifyPlugins("afterTooltipDraw", i));
    },
    afterEvent(t, e) {
      var i;
      t.tooltip &&
        ((i = e.replay), t.tooltip.handleEvent(e.event, i, e.inChartArea) && (e.changed = !0));
    },
    defaults: {
      enabled: !0,
      external: null,
...
class CategoryScale extends Scale {
  ...
  determineDataLimits() {
    ...
    "ticks" === this.options.bounds && (t || (i = 0), e || (a = this.getLabels().length - 1)),
      (this.min = i),
      (this.max = a);
  }
  buildTicks() {
...
function generateTicks$1(t, e) {
  ...
  for (
    ...
    (c && _ !== n
      ? (i.push({ value: n }),
        _ < n && S++,
        almostEquals(Math.round((_ + S * x) * b) / b, n, relativeLabelSize(n, d, t)) && S++)
      : _ < n && S++);
    S < k;
    ++S
  ) {
  ...
  return (
    m && c && y !== r
      ? i.length && almostEquals(i[i.length - 1].value, r, relativeLabelSize(r, d, t))
...
class LinearScaleBase extends Scale {
  ...
  parse(t, e) {
    return isNullOrUndef(t) || (("number" == typeof t || t instanceof Number) && !isFinite(+t))
      ? null
      : +t;
  }
  handleTickRangeOptions() {
    ...
    var n,
      ...
      o = (t) => (a = e ? a : t),
      l = (t) => (s = i ? s : t);
    t && ((r = sign(a)), (n = sign(s)), r < 0 && n < 0 ? l(0) : 0 < r && 0 < n && o(0)),
      a === s && ((r = 0 === s ? 1 : Math.abs(0.05 * s)), l(s + r), t || o(a - r)),
      (this.min = a),
      (this.max = s);
  }
  getTickLimit() {
...
class LogarithmicScale extends Scale {
  ...
  handleTickRangeOptions() {
    ...
    var t = (t) => (a = e ? a : t),
      n = (t) => (s = i ? s : t);
    a === s && (a <= 0 ? (t(1), n(10)) : (t(changeExponent(a, -1)), n(changeExponent(s, 1)))),
...
function measureLabelSize(t, e, i) {
  return (
    (i = isArray(i) ? i : [i]), { w: _longestText(t, e.string, i), h: i.length * e.lineHeight }
  );
}
...
function updateLimits(t, e, i, a, s) {
  ...
  a.start < e.l
    ...
    s.start < e.t
      ...
      : s.end > e.b && ((o = (s.end - e.b) / i), (t.b = Math.max(t.b, e.b + o)));
}
...
function drawPointLabelBox(t, e, i) {
  ...
  isNullOrUndef(l) ||
    ...
    Object.values(a).some((t) => 0 !== t)
      ? (t.beginPath(), addRoundedRectPath(t, { x: l, y: s, w: r, h: i, radius: a }), t.fill())
      : t.fillRect(l, s, r, i));
}
...
function parse(t, e) {
  ...
  return (
    ...
    null === (r = isNumberFinite(r) ? r : "string" == typeof a ? i.parse(r, a) : i.parse(r))
      ? null
      : +(r = s
...
function addTick(t, e, i) {
  var a, s;
  i
    ? i.length && (({ lo: a, hi: s } = _lookup(i, e)), (t[i[a] >= e ? i[a] : i[s]] = !0))
    : (t[e] = !0);
}
  ...
  buildTicks() {
    ...
    return (
      (this._unit =
        e.unit ||
        (i.autoSkip
          ? determineUnitForAutoTicks(e.minUnit, this.min, this.max, this._getLabelCapacity(s))
          : determineUnitForFormatting(this, r.length, e.minUnit, this.min, this.max))),
      (this._majorUnit =
        i.major.enabled && "year" !== this._unit ? determineMajorUnit(this._unit) : void 0),
      this.initOffsets(a),
      t.reverse && r.reverse(),
...
function interpolate(t, e, i) {
  let a = 0,
    ...
    l;
  i
    ? (e >= t[a].pos && e <= t[s].pos && ({ lo: a, hi: s } = _lookupByKey(t, "pos", e)),
      ({ pos: n, time: o } = t[a]),
      ({ pos: r, time: l } = t[s]))
    : (e >= t[a].time && e <= t[s].time && ({ lo: a, hi: s } = _lookupByKey(t, "time", e)),
      ({ time: n, pos: o } = t[a]),
      ({ time: r, pos: l } = t[s]));
  i = r - n;
